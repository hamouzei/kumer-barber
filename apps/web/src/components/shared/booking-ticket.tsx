...
function generateAndDownloadTicketPng(
  ...
  ctx.fillStyle = "#F5F0E8";
  // Deterministic bar widths based on ref code
...
export function BookingTicket({
  ...
  return (
    <div className={cn("flex flex-col items-center gap-6", className)}>
      {/* ─── The Printable / Visual Ticket Card ─── */}
      <div
        ref={ticketRef}
        id="kumer-ticket"
        className="relative w-full max-w-[420px] rounded-3xl p-[1.5px] bg-gradient-to-b from-brass/50 via-brass/20 to-brass/45 shadow-[0_12px_45px_rgba(0,0,0,0.6)] transition-all duration-300 hover:shadow-[0_16px_55px_rgba(200,150,90,0.18)]"
      >
      ...
      {/* ─── Action Controls: Download PNG, Copy Code & Print ─── */}
