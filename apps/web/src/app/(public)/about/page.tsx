...
export default function AboutPage() {
  ...
  const bodyText =
    aboutContent?.body ||
    `At Kumer, we believe that a great haircut is more than just a trim — it's an experience. Founded with a passion for precision and a commitment to quality, we deliver premium grooming services that leave our clients feeling confident and refreshed.
